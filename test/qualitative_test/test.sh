...
CUDA_VISIBLE_DEVICES=0 python test.py --dataroot test_data --name neg_all_epoch --model test --phase test --no_dropout --display_id 0 --dataset_mode single --which_epoch A5_2
